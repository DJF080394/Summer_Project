...
def run_data_collection():
    ...
    CONVEYOR_URDF = r"E:\Google\SummerProject\bullet3-3.25\bullet3-3.25\Conveyor-Belt-Tube-Detection-System-main\Conveyor-Belt-Tube-Detection-System-main/conveyor_belt_draft.urdf"
    TUBE_URDF_PATHS = [
